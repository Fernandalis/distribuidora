...
class CategoriaSeeder extends Seeder
{
    ...
    public function run(): void
    {
         DB::table('Categorias')->insert(
            ...
            ['nome' => "Galão de água", 'descricao'=>"10L - Retornável", 'imagem'=>"https://encurtador.com.br/HTyJ"],
            ...
            ['nome' => "Galão de água", 'descricao'=> "10L - Descartável", 'imagem'=>"https://encurtador.com.br/HLXY"],
            ...
            ['nome' => "Fardo de Garrafinhas de água", 'descricao'=> "500mL - contém 12 garrafinhas o fardo", 'imagem'=>"https://encurtador.com.br/KPeE"],

            ['nome' => "Fardo de Garrafinhas de água", 'descricao'=> "1,5L -contém 12 garrafas o fardo", 'imagem'=>"https://encurtador.com.br/OKSg"],

            ['nome' => "Caixa de copos de água", 'descricao'=> "copos de 200mL", 'imagem'=>"https://encurtador.com.br/znHC"],

            ['nome' => "Caixa de copo de água", 'descricao'=> "copos de 300mL", 'imagem'=>"https://encurtador.com.br/dhCx"],
            ]
        );
    }
}
